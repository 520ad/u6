...
class Http
{
     ...
     * @return mixed|string
     */
    public static function getParses($url, $params = [], $options = [])
    {
        //如果您需要修改请求规则，避免其他引用异常请新建一个sendRequest方法
        $req = self::sendRequest($url, $params, 'GET', $options);
        return $req['ret'] ? $req['msg'] : '';
    }
     ...
     * @return mixed|string
     */
    public static function getStore($url, $params = [], $options = [])
    {
        //如果您需要修改请求规则，避免其他引用异常请新建一个sendRequest方法
        $req = self::sendRequest($url, $params, 'GET', $options);
        return $req['ret'] ? $req['msg'] : '';
     ...
     * @return mixed|string
     */
    public static function getLive($url, $params = [], $options = [])
    {
        //如果您需要修改请求规则，避免其他引用异常请新建一个sendRequest方法
        $req = self::sendRequest($url, $params, 'GET', $options);
        return $req['ret'] ? $req['msg'] : '';
