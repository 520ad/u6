define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'box/parses/index' + location.search,
                    add_url: 'box/parses/add',
                    edit_url: 'box/parses/edit',
                    del_url: 'box/parses/del',
                    multi_url: 'box/parses/multi',
                    import_url: 'box/parses/import',
                    table: 'box_parses',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'box/parses/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
