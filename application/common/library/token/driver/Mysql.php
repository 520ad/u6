...
class Mysql extends Driver
{
     ...
     * @return bool
     */
    public function set($token, $user_id, $appid = 888, $expire = null)
    {
        ...
        $this->handler->insert(['token' => $token, 'user_id' => $user_id, 'appid' => $appid, 'createtime' => time(), 'expiretime' => $expiretime]);
        return true;
    }
