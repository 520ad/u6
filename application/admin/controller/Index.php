...
class Index extends Backend
{
    ...
    protected $_authorizationValidityTime = "请刷新后台";
    protected $_authList = "请刷新后台";
    ...
    public function index()
    {
        ...
        $authdata['type'] = "永久授权";
        $authdata['cache'] = $this->_authorizationValidityTime;
        $authdata['authList'] = json_decode($this->_authList, true);
        $authdata['database'] = is_file('./uploads/database.php');
        $this->view->assign('auth_type', $authdata);
        $this->view->assign('version', Config::get('version'));
